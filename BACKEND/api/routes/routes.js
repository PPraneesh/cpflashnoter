...
const { cp_controller,get_cp, delete_cp_controller,share_cp_controller,get_public_cp_controller, delete_public_cp_controller, edit_cp } = require('../controllers/cp_controller');
