    ...
    <>
      {loadLogin != 0 && (
        <div className="fixed inset-0 bg-[#0d1117]/80 backdrop-blur-sm flex flex-col items-center justify-center z-50">
          ...
          {loadLogin == 1 && (
            <>
              <h1 className="text-xl text-white">Complete the login</h1>
              <p className="text-xs text-white">
                If you are unable to login reload the page
              </p>
            </>
          )}
          {loadLogin == 2 && (
            <>
              <h1 className="text-xl text-white">Redirecting you in a sec</h1>
              <p className="text-xs text-white">
                If you are not redirected to home, reload the page
              </p>
            </>
          )}
        </div>
      ...
      <section
        id="hero"
        className="pt-20 bg-neutral-900 min-h-[70vh] relative overflow-hidden"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate__animated animate__fadeInLeft">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                <span className="text-blue-500">AI-Powered</span> DSA Notes That
                Remember For You
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                Never forget your DSA solutions again. Create smart notes,
                follow automated revision schedules, and ace your technical
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  onClick={handleLogin}
                  href="#signup"
                  className="inline-flex items-center justify-center px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-150 text-lg"
                >
                  Get Started Free
                  <svg
                ...
                <a
                  href="#features"
                  className="inline-flex items-center justify-center px-8 py-3 border border-gray-600 text-white font-medium rounded-lg hover:border-gray-400 transition duration-150 text-lg"
                >
                  See How It Works
                </a>
              </div>
      ...
      <section id="problem" className="py-20 bg-neutral-900">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16 animate__animated animate__fadeIn">
        <h2 className="text-3xl sm:text-4xl font-bold mb-4">
          The DSA Interview Preparation Challenge
        </h2>
        <p className="text-xl text-neutral-300 max-w-3xl mx-auto">
          Why do talented programmers struggle with DSA interviews despite solving numerous problems?
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
          ...
          <h3 className="text-xl font-semibold mb-3 text-white">Note-Taking Fatigue</h3>
          <p className="text-neutral-200">Most students skip making notes after solving DSA problems due to exhaustion and time constraints.</p>
        </div>

        <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
          <div className="mb-4 text-2xl text-blue-600">🤔</div>
          <h3 className="text-xl font-semibold mb-3 text-white">Memory Retention</h3>
          <p className="text-neutral-200">Solutions fade from memory within days, making interview preparation ineffective.</p>
        </div>

        <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
          <div className="mb-4 text-2xl text-blue-600">📅</div>
          <h3 className="text-xl font-semibold mb-3 text-white">Revision Chaos</h3>
          <p className="text-neutral-200">Maintaining a consistent revision schedule becomes overwhelming without proper organization.</p>
        </div>

        <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
          <div className="mb-4 text-2xl text-blue-600">📊</div>
          <h3 className="text-xl font-semibold mb-3 text-white">No Progress Tracking</h3>
          <p className="text-neutral-200">Lack of metrics to measure understanding and confidence levels in solved problems.</p>
        </div>

        <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
          <div className="mb-4 text-2xl text-blue-600">🔄</div>
          <h3 className="text-xl font-semibold mb-3 text-white">Inconsistent Practice</h3>
          <p className="text-neutral-200">No structured way to revisit problems based on confidence levels and understanding.</p>
        </div>
        <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
          <div className="mb-4 text-2xl text-blue-600">📱</div>
          <h3 className="text-xl font-semibold mb-3 text-white">Accessibility Issues</h3>
          <p className="text-neutral-200">Notes and solutions aren't readily available across different devices when needed.</p>
        </div>
      </div>
      ...
      <div className="mt-16 text-center animate__animated animate__fadeIn">
        <p className="text-lg text-neutral-300 mb-6 max-w-2xl mx-auto">
          These challenges can make your DSA preparation inefficient and affect your interview performance. But what if there was a better way?
        </p>
        <button onClick={handleLogin} className="px-6 py-3 bg-blue-600 text-white rounded-lg text-lg font-semibold hover:bg-blue-700 transition duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Students Love CPNoter
            </h2>
            <p className="text-xl text-gray-300">
              Transform your DSA preparation with AI-powered features designed
              for success
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300">
                Create comprehensive DSA notes instantly with our AI assistant.
                No more manual note-taking hassles.
              </p>
            </div>
            ...
            <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300">
                Automatically scheduled revisions based on your learning
            ...
            <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300">
                Monitor your understanding with detailed metrics and confidence
            ...
            <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300">
                Practice with random questions from your solved problems to stay
                interview-ready.
              </p>
            </div>
            ...
            <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300">
                Access your notes and revision schedule from any device,
                anytime, anywhere.
              </p>
            </div>
            ...
            <div className="bg-neutral-700 rounded-xl p-6 hover:bg-neutral-600 transition-all duration-300 animate__animated animate__fadeIn">
              ...
              <p className="text-gray-300">
                Simply copy your question and solution - let our AI handle the
                rest of the work.
              </p>
            </div>
          </div>
      ...
      <section id="howItWorks" className="py-20 bg-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Three simple steps to master your DSA preparation
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="relative bg-neutral-800 rounded-xl p-8 border border-neutral-700 animate__animated animate__fadeInLeft">
              <div className="absolute -top-6 left-8 bg-blue-600 rounded-full w-12 h-12 flex items-center justify-center text-2xl font-bold text-white">
                1
              </div>
              <div className="mt-4">
                ...
                <p className="text-gray-300 mb-6">
                  Just copy your DSA question and solution into CPNoter. That
            ...
            <div className="relative bg-neutral-800 rounded-xl p-8 border border-neutral-700 animate__animated animate__fadeInUp">
              <div className="absolute -top-6 left-8 bg-purple-600 rounded-full w-12 h-12 flex items-center justify-center text-2xl font-bold text-white">
                2
              </div>
              <div className="mt-4">
                <h3 className="text-2xl font-bold text-white mb-4">
                ...
                <p className="text-gray-300 mb-6">
                  Our AI creates personalized, comprehensive notes with key
            ...
            <div className="relative bg-neutral-800 rounded-xl p-8 border border-neutral-700 animate__animated animate__fadeInRight">
              <div className="absolute -top-6 left-8 bg-green-600 rounded-full w-12 h-12 flex items-center justify-center text-2xl font-bold text-white">
                3
              </div>
              <div className="mt-4">
                <h3 className="text-2xl font-bold text-white mb-4">
                ...
                <p className="text-gray-300 mb-6">
                  Follow your personalized revision schedule and track your
                  progress.
                </p>
                <div className="bg-neutral-700 rounded-lg p-4">
          ...
          <div className="mt-16 text-center">
            <button
              onClick={handleLogin}
              className="inline-flex items-center justify-center px-8 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-150 text-lg animate__animated animate__pulse animate__infinite"
            >
              Start Your Journey
              <svg
                className="w-5 h-5 ml-2"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate__animated animate__fadeInLeft">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                AI-Powered Notes That{" "}
                <span className="text-blue-500">Think Like You</span>
              </h2>
              <p className="text-xl text-gray-300 mb-8">
                Our advanced AI doesn{"'"}t just create notes - it understands
                your learning style and creates personalized content that
                resonates with you.
              </p>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      AI analyzes your code solution and breaks down complex
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Identifies similar patterns across problems to strengthen
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Notes evolve based on your understanding and confidence
                      levels during revision.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-neutral-900 rounded-xl p-6 shadow-2xl border border-neutral-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-green-600/10 rounded-lg">
                    ...
                    <svg
                      className="w-5 h-5 text-greethe</div>n-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
      ...
      <section id="revisionSystem" className="py-20 bg-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Never forget what you{"'"}ve learned with our intelligent revision
              scheduler
            </p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 animate__animated animate__fadeInRight">
              <div className="space-y-4">
                ...
                <p className="text-gray-300">
                  Our AI-powered system creates a personalized revision schedule
                  based on:
                </p>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-300">
                      Your confidence level after each revision
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
                ...
                <div className="mt-4 grid grid-cols-7 gap-2">
                  {Array(28)
                    ...
                    .map((_, i) => (
                      <div
                        key={i}
                        className="w-full h-8 bg-green-700 rounded-sm"
      ...
      <section id="prepMode" className="py-20 bg-neutral-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Test yourself with random questions from your codebase
            </p>
          </div>
            ...
            <div className="space-y-8 animate__animated animate__fadeInRight">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 bg-neutral-700 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Questions picked based on your revision history
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 bg-neutral-700 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Get progressive hints to jog your memory
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 bg-neutral-700 p-4 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Monitor your interview readiness
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  <button
                    onClick={handleLogin}
                    className="inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-150 w-full"
                  >
                    Try Prep Mode Now
                    <svg
                      className="w-5 h-5 ml-2"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-neutral-800 rounded-2xl p-8 border border-neutral-700 animate__animated animate__fadeInLeft">
                ...
                <a
                  onClick={handleLogin}
                  className="block text-center px-6 py-3 bg-neutral-700 text-white rounded-lg hover:bg-neutral-600 transition duration-150"
                >
                  Get Started Free
                </a>
              </div>
              ...
              <div className="bg-blue-600 rounded-2xl p-8 border border-blue-500 relative overflow-hidden animate__animated animate__fadeInRight">
                ...
                <a
                  href="#signup"
                  className="block text-center px-6 py-3 bg-white text-blue-600 rounded-lg hover:bg-blue-50 transition duration-150"
                >
                  Get Premium Access
                </a>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 mb-12 animate__animated animate__fadeInUp animate__delay-2s">
              <Link
                onClick={handleLogin}
                className="w-full sm:w-auto inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition duration-150 text-lg group"
              >
                Get Started Free
                <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6">
                Revolutionizing DSA preparation with AI-powered notes and smart
                revision system.
              </p>
  ...
  const faqs = [
    {
      ...
      answer:
        "Simply paste your DSA question and solution. Our AI analyzes your code, identifies key concepts, and generates comprehensive notes tailored to your understanding level. The notes include time complexity analysis, approach explanation, and key takeaways.",
    },
    {
      question: "How is the revision schedule determined?",
      answer:
        "Our algorithm considers multiple factors: your confidence level after each revision, the complexity of the problem, and the time since last revision. This creates a personalized schedule that ensures optimal retention and learning.",
    },
    {
      question: "Can I access my notes offline?",
      answer:
        "Yes! Once you've generated notes, they're available offline on any device. You can access and revise your notes even without an internet connection.",
    },
    {
      question: "What's included in the Premium plan?",
      answer:
        "Premium gives you 10 note generations per day, unlimited revisions, unlimited prep mode questions, advanced analytics, and priority support. All this for just ₹50/day - perfect for serious interview preparation.",
    },
    {
      question: "How does the Prep Mode work?",
      answer:
        "Prep Mode randomly selects questions from your solved problems, focusing on those you need to review. It provides progressive hints and tracks your confidence level to help you prepare effectively for interviews.",
    },
  ];
